...
export const { useAllProductsQuery , useUpdateProductMutation, useDeleteProductMutation } = productAPI;
export const { useCategoriesQuery, useSearchProductsQuery, useNewProductMutation, useProductDetailsQuery } = productAPI;